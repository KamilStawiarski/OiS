...
\begin{frame}{Rezystor}
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			\begin{figure}
				\includegraphics[scale=0.2, alt={Na zdjęciu widać szereg rezystorów o różnych mocach znamionowych, od bardzo małych oporników węglowych 1/8 W do większych, cylindrycznych elementów 2 W.
							Poniżej pokazane są większe rezystory ceramiczne o mocach 10 W i 20 W, przy linijkach z podziałką w centymetrach do porównania ich rozmiarów.}]{imags/L1/Carbon_and_ceramic_resistors_of_different_power_ratings.jpg}
