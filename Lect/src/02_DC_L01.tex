...
\begin{frame}{Rezystor w obwodzie}
	\begin{columns}
		...
		\begin{column}{0.3\textwidth}
			\begin{figure}
				\includegraphics[scale=0.15, alt={Symbol rezystora z zaznaczonymi zwrotami prądu iR oraz napięcia uR na tym elemencie. Strzałka prądu skierowana jest w dół przez rezystor, a strzałka napięcia w górę, co ilustruje przyjętą biegunowość przy zapisie równań obwodu.}]{imags/L1/R.png}
...
\begin{frame}{Źródło napięciowe}
	\begin{columns}
		...
		\begin{column}{0.3\textwidth}
			\begin{figure}
				\includegraphics[scale=0.15, alt={Symbol źródła napięcia (okrąg) z zaznaczonym prądem iE płynącym pionowo w górę przez element. Obok narysowano strzałkę z literą E, oznaczającą siłę elektromotoryczną lub napięcie źródła, ze zwrotem ku górze.}]{imags/L1/E.png}
...
\begin{frame}{Źródło prądowe}
	\begin{columns}
		...
		\begin{column}{0.3\textwidth}
			\begin{figure}
				\includegraphics[scale=0.15, alt={Symbol źródła prądowego (podwójny okrąg) z prądem J płynącym pionowo w górę przez element. Obok znajduje się strzałka z oznaczeniem uJ, określająca przyjęty zwrot napięcia na źródle prądowym.}]{imags/L1/J.png}
