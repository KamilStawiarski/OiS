...
\begin{frame}{Przykłady}
	\begin{enumerate}
		\item[\bt] $F_1(s) =  \frac{1}{s+4}$
		\item[\bt] $F_2(s) =  \frac{1}{(s+2)^3}$
		\item[\bt] $F_3(s) =  \frac{5}{s^2+16}$
		\item[\bt] $F_4(s) =  \frac{1}{s^2+8s+16}$
		\item[\bt] $F_5(s) =  \frac{1}{(s+1)(s+2)} = \frac{A}{s+1} + \frac{B}{s+2}$
		\item[\bt] $F_6(s) =  \frac{s}{(s+1)^3} = \frac{A}{(s+1)^3} + \frac{B}{(s+1)^2} + \frac{C}{s+1}$
		\item[\bt] $F_7(s) =  \frac{s^2}{(s+1)^2(s+2)} = \frac{A}{(s+1)^2} + \frac{B}{s+1} + \frac{C}{s+2}$
		\item[\bt] $F_8(s) =  \frac{1}{(s^2+1)(s^2-1)} = \frac{As+B}{s^2+1} + \frac{C}{s+1} + \frac{D}{s-1}$
	\end{enumerate}
